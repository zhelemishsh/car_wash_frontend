...
class WashOffersRepository {
  ...
  final List<CarWashOffer> _offers = [
    CarWashOffer(1, MapPosition(59.94473559335115, 30.25908023387789), "CarWash", 500, "ул. Пушкина 25 75", 5.00, TimeOfDay.now(), TimeOfDay.now()),
    CarWashOffer(2, MapPosition(59.95688567196063, 30.33330642887048), "Мойка 24/7", 300, "ул. Ленина 43 24", 2.99, TimeOfDay.now(), TimeOfDay.now()),
    ...
    CarWashOffer(4, MapPosition(59.982920849286714, 30.384228898529784), "Автомойка", 423, "ул. Горького 14 56", 4.88, TimeOfDay.now(), TimeOfDay.now()),
  ];
  int _currentCount = 0;
